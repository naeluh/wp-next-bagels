  ...
  return (
    ...
    >
      <div className='flex-1 z-10'>
        <h3 className='text-4xl md:text-6xl font-bold tracking-tighter leading-tight mb-4 text-white'>
          {title}
        </h3>
        <span className={styles.borderBottom}></span>
        <h4 className='text-2xl md:text-4xl font-regular tracking-tighter leading-tight mb-4 text-white'>
          {quote}
        </h4>
        <div>
