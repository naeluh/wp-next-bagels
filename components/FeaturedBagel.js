...
const FeaturedBagel = ({ title, subtitle, img }) => {
  return (
    <section className='px-5 py-8 flex-col md:flex-row flex lg:items-center md:justify-between mb-16 md:mb-24 md:px-8 md:py-8 md:pb-12 border-m-yellow border-12'>
